...
import mujoco
import numpy as np
from .robot_create import RobotGenerator
import robopal_part
...
class BaseRobot(object):
    ...
    :param robot(str): manipulator name
    """
    ...
    def __init__(self,
                 ...
                 robot: Union[str, Iterable[str]] = None,
                 ):
        ...
        logging.info(f'Activated robot name is : { self.robot_name}')
